...
epoch: E0008
date: 2026-04-23
hook: "I asked the model to add token counts to the telemetry. The model came back with three reasons not to ship. A five-minute bench killed all three."
...
og_description: "I asked the model to add token counts to the telemetry. The model came back with three reasons not to ship. A five-minute bench killed all three."
og_type: article
twitter_card: summary_large_image
twitter_title: "Penny Wise and Pound Foolish — Why I Build the Dream House Before Cutting"
twitter_description: "I asked the model to add token counts to the telemetry. The model came back with three reasons not to ship. A five-minute bench killed all three."
derives_from:
