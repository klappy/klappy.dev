...
| house_canon_cited | klappy, canon | "house_canon_cited: House canon not cited — name a klappy:// URI (or the word canon), or the official null (no house canon); stack folklore (CF, vodka) is not a cite" |
