...
| house_install_cited | install, installation | "house_install_cited: House install not cited — name the installation repo/path inspected, or the official null (no house install)" |
