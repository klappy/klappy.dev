...
| world_prior_cited | world-prior, prior-art, observed-reference | "world_prior_cited: World prior not cited — name the observed external reference (CHECKLIST 10), or the official null (no world prior)" |
| house_install_cited | install, installation, repo-path, inspected-repo | "house_install_cited: House install not cited — name the installation repo/path inspected (CHECKLIST 11), or the official null (no house install)" |
| house_canon_cited | klappy, canon, canon-cited | "house_canon_cited: House canon not cited — name a klappy:// URI (or the word canon), or the official null (no house canon); stack folklore (CF, vodka) is not a cite" |
