...
Three essays in a trilogy:

1. *Copy. Paste.* (March 2026) — names the defining ritual of AI-augmented work in 2025 and the first quarter of 2026. Closes with a wish: *I hope this essay ages poorly. I can't wait to not be able to imagine it.*
2. *Fourteen Hours with Opus 4.7* (April 2026) — first session with the workflow that ended the copy-paste ritual. Native containers, no copy-paste between tools. The wish, delivered.
3. *Shifting Bottlenecks, Climbing Ladders* (April 2026) — the framework that emerged from sessions 2 through 6, naming the next ritual (swipe-tap-continue) before it could become the next *Copy. Paste.*
...
*In March I wrote an essay hoping it would age poorly. By April it had. This is the celebration I owe it.*
...
- Not introduce new frameworks. The trilogy already has them.
...
When time allows. Not blocking anything. The trilogy stands without it. The essay would be a fourth piece that makes the pattern visible, not a piece the trilogy needs to be complete.

If a natural moment arises (the *Copy. Paste.* essay's anniversary, a noticeable adoption shift in the wider community, another ritual obsolescing on a similar timeline), that is a good trigger. Otherwise queued.
