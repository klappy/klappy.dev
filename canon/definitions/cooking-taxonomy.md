...
title: "The Cooking Taxonomy — Recipes, Cookbooks, and Menus as the Client-Facing Frame"
audience: canon
exposure: nav
tier: 2
voice: neutral
...
*Confidence: high (ratified frame, captain, 2026-08-07; service-format and pricing details still settling).*

This taxonomy is the client-facing frame for the house's AI and software work. Its unit is the recipe: declared ingredients, declared instructions, declared product, so nothing about a dish is discovered mid-execution. Scopes nest by size (dish, meal, meal plan; recipe, cookbook). Served dishes are projections of recipes, mirroring the cockpit invariant that the log is truth and boards are projections. Clients order from a menu and never see the kitchen; gates stay in the kitchen; customization is measured by what the client supplies, not by who owns the kitchen. The frame wraps, and does not replace, the airline/dispatch frame the crew flies under. It is chosen to be simple, fun, clean, and understandable, orderable by a non-technical first diner.

## 1. The Unit
*Confidence: high (ratified core).*
...
*Confidence: high (ratified; grounded in the projection corpus).*
...
The same invariant governs the cockpit: the log is truth, boards and briefs are projections, one law on both sides of the kitchen door (see klappy://writings/artifacts-are-projections, and klappy://canon/bootstrap/flight-deck-model for the cockpit frame).
...
A further disposition sits before the others, COOK LONGER: some dishes are not wrong, only not done, and continuing is distinct from seasoning. The full set at the pass: serve, cook longer, season, scrap, amend.

## 5. The Menu
*Confidence: medium (frame ratified; the three service formats are not yet run in the field).*
...
Three service formats, identified though not yet proven by engagements (three audiences named, zero run to date): counter service — one diner, one sitting, one inline taste; catering — engagements ordered as meal plans with staged gates; culinary school — the client buys the cookbook, learns to cook, and raises a curator of their own. One kitchen serves all three.

The menu exists because cooking became instant. When execution is no longer the constraint, planning and tasting are, and a menu with a meal plan is how a kitchen organizes the new bottleneck instead of drowning in fast dishes. This is the client-facing face of klappy://canon/principles/capability-is-not-permission: when creation goes frictionless, deliberation becomes the constraint.
...
*Confidence: medium (ratified frame; boundaries between tiers still settling).*
...
## 8. The 99/1 Thesis
*Confidence: medium (captain's claim, 2026-08-04; compounding not yet measured across many contracts).*


The client's product is almost entirely unique; the process that builds it is almost entirely shared. Uniqueness enters through ingredients, never by rewriting recipes. Each new dish cooked from a clear recipe compounds the kitchen; mixing and matching grows with the cookbook. This is why a cookbook is a business and not a binder. Falsifier: if new products repeatedly forced rewriting recipes rather than swapping ingredients, if uniqueness kept demanding structural process change, the 99/1 split would be false and the cookbook would be a binder after all.
...
*Confidence: high (reconciliation ratified).*
...
The sub-recipe law, where a recipe's output can be a prerequisite ingredient of another recipe: meringue is its own recipe before lemon meringue pie, a brand story is its own recipe before marketing. Dependencies are declared as prepared-before ingredients, never folded into one longer recipe.
...
## 13. Kitchen Roles
*Confidence: medium (roles named; not yet exercised across a full engagement).*
...
*Confidence: high (ratified acceptance test).*
...
*Confidence: medium (one example shipped, one pending: Covenant, due 2026-08-14).*
...
## 16. Open Questions
*Confidence: low (open by definition; these are the live unknowns).*
