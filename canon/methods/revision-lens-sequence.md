...
3. **Author controls the pace:** The author may say "do the next three" or "skip sensitivity, we'll do that after Han reviews" or "combine Socratic and confession."
...
- [Book Governance Additions](klappy://docs/book/governance-additions-2026-02-27) — the source of Passes 3 and 5
- [Self-Audit Checklist](klappy://canon/methods/self-audit) — the reflection layer this method extends
